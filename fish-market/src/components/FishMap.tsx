...
const DEBUG = 0; // Set to 1 to show debug borders and editor
...
export const FishMap = () => {
  ...
  const handleCopyJson = () => {
    ...
    // For now just dumping the full JSON
            ...
            return (
              <motion.div
                ...
                className={`absolute cursor-pointer group 
                  ${DEBUG ? 'z-20' : 'z-10'}
                  ${DEBUG && isSelected ? 'border-4 border-blue-500 bg-blue-400/30' : ''}
                  ${DEBUG && !isSelected ? 'border-2 border-green-400 bg-green-400/20' : ''}
                `}
                style={{
