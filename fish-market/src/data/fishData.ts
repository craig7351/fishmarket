...
export const fishData: FishInfo[] = [
  {
    ...
    position: { top: 18, left: 3, width: 12, height: 8 }
  },
  {
    id: '2',
    name: '尖吻鱸',
    ...
    position: { top: 18, left: 16, width: 12, height: 8 }
  },
  {
    id: '3',
    name: '虱目魚',
    ...
    position: { top: 18, left: 29, width: 12, height: 8 }
  },
  {
    id: '4',
    name: '真鯛',
    ...
    position: { top: 27, left: 3, width: 12, height: 8 }
  },
  {
    id: '5',
    name: '鬼頭刀',
    ...
    position: { top: 27, left: 80, width: 13, height: 8 } // 範例位置
  }
];
